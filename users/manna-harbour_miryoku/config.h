...
#define MIRYOKU_LAYERMAPPING_EXTRA LAYOUT_split_3x6_3
...
TO(U_EXTRA),       TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              RGB_MOD,           RGB_HUI,           RGB_SAI,           RGB_VAI,           RGB_TOG,           \
...
KC_LSFT,        KC_Z,              KC_X,              KC_C,              KC_V,              KC_B,              KC_N,              KC_M,              KC_COMM,           KC_DOT,            KC_SLSH,     KC_RGUI,     \
                            LT(U_TAP, KC_LALT),       KC_SPC,            KC_TAB,            TO(U_BASE),        KC_BSPC,           KC_DEL

#define MIRYOKU_LAYER_TAP \
KC_TRNS,        KC_TRNS,           KC_TRNS,           KC_1,              KC_2,              KC_3,              KC_TRNS,           KC_TRNS,              KC_TRNS,        KC_TRNS,            KC_TRNS,     KC_TRNS,     \
KC_TRNS,        KC_TRNS,           KC_TRNS,           KC_TRNS,           KC_4,              KC_5,              KC_TRNS,           KC_TRNS,              KC_TRNS,        KC_TRNS,            KC_TRNS,     KC_TRNS,     \
